...
(define skk-go-left-key '("left" "<IgnoreCase><Control>j"))
(define skk-go-left-key? (make-key-predicate '("left" "<IgnoreCase><Control>j")))
(define skk-go-right-key '("right" "<IgnoreCase><Control>l"))
(define skk-go-right-key? (make-key-predicate '("right" "<IgnoreCase><Control>l")))
