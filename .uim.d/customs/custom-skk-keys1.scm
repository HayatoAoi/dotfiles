(define skk-on-key '("zenkaku-hankaku" "<Shift> " "<IgnoreCase><Control>f"))
(define skk-on-key? (make-key-predicate '("zenkaku-hankaku" "<Shift> " "<IgnoreCase><Control>f")))
...
(define skk-commit-key '("<IgnoreCase><Control>m"))
(define skk-commit-key? (make-key-predicate '("<IgnoreCase><Control>m")))
(define skk-cancel-key '(generic-cancel-key))
(define skk-cancel-key? (make-key-predicate '(generic-cancel-key?)))
(define skk-sticky-key '("Henkan_Mode"))
(define skk-sticky-key? (make-key-predicate '("Henkan_Mode")))
