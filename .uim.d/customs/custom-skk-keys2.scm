...
(define skk-conv-opposite-case-key '("<IgnoreCase><Alt>u"))
(define skk-conv-opposite-case-key? (make-key-predicate '("<IgnoreCase><Alt>u")))
(define skk-begin-completion-key '("tab"))
(define skk-begin-completion-key? (make-key-predicate '("tab")))
(define skk-next-completion-key '("<IgnoreShift>." "tab"))
(define skk-next-completion-key? (make-key-predicate '("<IgnoreShift>." "tab")))
(define skk-prev-completion-key '(","))
(define skk-prev-completion-key? (make-key-predicate '(",")))
(define skk-new-completion-from-current-comp-key '("<IgnoreCase><Control><Alt>i"))
(define skk-new-completion-from-current-comp-key? (make-key-predicate '("<IgnoreCase><Control><Alt>i")))
...
(define skk-state-direct-no-preedit-nop-key '("<IgnoreCase><Control>f"))
(define skk-state-direct-no-preedit-nop-key? (make-key-predicate '("<IgnoreCase><Control>f")))
