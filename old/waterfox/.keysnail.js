...
key.setGlobalKey([['<convert>', 'n'], ['ESC', '<up>'], ['M-<up>']], function (ev, arg) {
...
key.setGlobalKey([['ESC', 'f'], ['C-x', 'C-f'], ['M-f']], function (ev) {
...
key.setEditKey([['ESC', 'h'], ['ESC', '<delete>'], ['C-M-h'], ['M-<delete>']], function (ev) {
...
key.setEditKey([['ESC', 'y'], ['C-M-y']], function (ev) {
...
key.setCaretKey([['ESC', 'f'], ['C-M-l'], ['w']], function (ev) {
                ev.target.ksMarked ? goDoCommand("cmd_selectWordNext") : goDoCommand("cmd_wordNext");
            }, 'キャレットを一単語右へ移動');

key.setCaretKey([['ESC', 'b'], ['C-M-j'], ['W']], function (ev) {
                ev.target.ksMarked ? goDoCommand("cmd_selectWordPrevious") : goDoCommand("cmd_wordPrevious");
            }, 'キャレットを一単語左へ移動');

key.setCaretKey([['ESC', 'v'], ['C-,'], ['b']], function (ev) {
